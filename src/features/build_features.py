...
# Load data
# --------------------------------------------------------------
df=pd.read_pickle("../../data/interim/02_outliers_removed_chauvenets.pk")
...
sub=df_squared[df_squared["label"]=="squat"][df_squared["category"]=="medium"][df_squared["participant"]=='D'][df_squared["duration"]==26]
